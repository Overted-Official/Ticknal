...
import { ChevronDown, Check, ShieldCheck, TrendingUp, Landmark } from '@/components/ui/icon-library';
    ...
    <header className="flex items-center justify-between gap-4 select-none pb-1">
      ...
      <div className="flex items-center gap-2">
        <span
          ...
          onClick={() => router.push('/dashboard?tab=banks')}
        >
          Dashboard
        </span>
      ...
      {/* Right: Action button to open Wallet Transactions */}
      <div className="flex items-center gap-2">
        <Link href="/wallet?tab=transactions" className="btn-token btn-secondary btn-compact">
