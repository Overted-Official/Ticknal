  ...
  return (
    ...
    >
      <motion.div 
        ...
        className="glass-panel bg-black border border-white/[0.12] rounded-md shadow-2xl w-full max-w-sm overflow-visible flex flex-col text-white"
      >
        ...
        <div className="p-6 space-y-4 overflow-visible max-h-[80vh]">
              ...
              <div className="w-full relative">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white/[0.04] border border-white/[0.08] rounded-md pl-9 pr-3 py-2 text-sm text-white font-semibold focus:outline-none focus:border-white/20 transition-all placeholder:text-white/30"
                  />
                </div>
                {/* Search Dropdown */}
                {isSearchOpen && (
          ...
          <div className="grid grid-cols-2 gap-3 font-mono">
            <div>
              ...
              <input
                ...
                className="w-full bg-white/[0.04] border border-white/[0.08] rounded-md px-3 py-2 text-xs text-white focus:outline-none focus:border-white/20 transition-all"
              />
            </div>
            <div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-white/[0.04] border border-white/[0.08] rounded-md px-3 py-2 text-xs font-mono font-semibold text-white focus:outline-none focus:border-white/20 transition-all"
              min="1"
            />
          </div>

          {/* Required Margin */}
          <div className="bg-white/[0.03] rounded-md p-3 flex justify-between items-center text-xs border border-white/[0.06] font-mono">
