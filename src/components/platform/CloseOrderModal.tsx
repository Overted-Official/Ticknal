  ...
  return (
    ...
    >
      <motion.div 
        ...
        className="glass-panel rounded-md shadow-2xl w-full max-w-sm overflow-visible flex flex-col text-white bg-black border border-white/[0.14]"
      >
        ...
        <div className="p-6 space-y-4 font-mono">
          ...
          {/* Close Proceeds */}
          <div className="bg-white/[0.03] rounded-md p-3 flex justify-between items-center text-xs border border-white/[0.09]">
        ...
        <div className="p-5 pt-0 shrink-0 flex gap-2.5">
          <button
            onClick={onClose}
            className="flex-1 py-2 rounded-md border border-white/[0.09] bg-white/[0.04] hover:bg-white/[0.08] text-white/80 font-medium text-xs transition-all"
          >
            Cancel
          </button>
          <button
