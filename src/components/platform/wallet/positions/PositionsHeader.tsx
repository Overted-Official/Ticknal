...
const WALLET_NAV_PAGES = [
  { label: 'Stock Positions', tab: 'positions', href: '/wallet?tab=positions', icon: Wallet },
  { label: 'Cash & Transactions', tab: 'transactions', href: '/wallet?tab=transactions', icon: Landmark },
...
export default function PositionsHeader() {
  ...
  return (
    <div className="flex items-center justify-between gap-4 shrink-0 select-none pb-1">
      {/* Single-line Breadcrumb & Title with Dropdown */}
