...
export default function SectorsKPIStrip({
  ...
  if (analysisMode === 'strategy' && signalsData?.summary) {
    ...
    return (
      <div className="w-full text-xs select-none font-sans shrink-0">
        {/* ── Mobile: 2×2 summary cards ───────────────────────────── */}
        <div className="grid grid-cols-2 gap-2 md:hidden">
          {/* Card 1: Cumulative ROI */}
          <div className="bg-white/[0.02] border border-plt-border-soft/60 rounded-xl p-3 flex items-center gap-2.5">
            ...
            <div className="flex flex-col min-w-0">
              <div className="flex items-center gap-1 flex-wrap">
                <span className="text-[10px] uppercase tracking-wider text-plt-muted font-semibold">Cum. ROI</span>
                {signalsData.summary.winRate !== undefined && signalsData.summary.winRate > 0 && (
                  <span className="text-[9px] font-semibold text-plt-profit bg-plt-profit/10 px-1 rounded border border-plt-profit/20">
          ...
          {/* Card 3: Active Longs */}
          <div className="bg-white/[0.02] border border-plt-border-soft/60 rounded-xl p-3 flex items-center gap-2.5">
            <div className="w-7 h-7 rounded-lg bg-plt-info/10 border border-plt-info/20 flex items-center justify-center text-plt-info shrink-0">
              <Zap size={14} />
            </div>
            <div className="flex flex-col min-w-0">
        ...
        {/* ── Desktop: full interactive filter row ────────────────── */}
        <div className="hidden md:flex w-full bg-white/[0.02] border border-plt-border-soft/60 rounded-xl p-2.5 px-4 flex-wrap md:flex-nowrap items-center justify-between gap-4">
          ...
          {/* 3. Active Longs Button with Clickable W / L Breadth Filter */}
          <div
            className={`flex items-center gap-2.5 min-w-[195px] p-1.5 px-2.5 rounded-xl border transition-all ${
    ...
    <div className="w-full text-xs select-none font-sans shrink-0">
      ...
      <div className="grid grid-cols-2 gap-2 md:hidden">
        ...
        <div
          ...
          className="bg-white/[0.02] border border-plt-border-soft/60 rounded-xl p-3 flex items-center gap-2.5 cursor-pointer hover:opacity-80 transition"
        ...
        >
          ...
          <div className="flex flex-col min-w-0">
            ...
            <span className="font-semibold text-xs text-plt-text truncate">
              {marketSummary.topSector}
            </span>
          </div>
        </div>

        {/* Card 3: Laggard Performer */}
        <div
        ...
        >
          ...
          <div className="flex flex-col min-w-0">
            <div className="flex items-center gap-1.5">
              <span className="text-[10px] uppercase tracking-wider text-plt-muted font-semibold">Laggard</span>
        ...
        <div className="bg-white/[0.02] border border-plt-border-soft/60 rounded-xl p-3 flex flex-col justify-center gap-1.5">
          ...
          <span className="text-[9px] text-plt-muted text-center">{gainersPct.toFixed(0)}% Bullish</span>
        </div>
      </div>

      {/* ── Desktop: existing full-width flex row ───────────────── */}
      <div className="hidden md:flex w-full bg-white/[0.02] border border-plt-border-soft/60 rounded-xl p-2.5 px-4 flex-wrap lg:flex-nowrap items-center justify-between gap-4">
        {/* 1. Market Turnover */}
