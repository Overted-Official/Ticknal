...
export default function QuickStartSection() {
  return (
    <section className="pt-28 px-6 md:px-10 pb-16 bg-transparent w-full">
      <div className="max-w-248 mx-auto">
        <motion.div
          ...
          className="relative rounded-xl p-8 md:p-14 border border-plt-border-strong bg-gradient-to-b from-plt-accent-soft to-plt-base text-center overflow-hidden shadow-accent"
        >
          {/* Radial Accent Glows */}
          ...
          <div className="relative z-10 flex flex-col items-center gap-6 max-w-2xl mx-auto">
            ...
            <h2 className="text-3xl md:text-hero-sm font-medium text-plt-text tracking-tight leading-hero">
              Ready to automate your trading?
            </h2>

            <p className="text-sm sm:text-base text-plt-subtle max-w-lg leading-relaxed">
