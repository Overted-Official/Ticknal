...
export default function WhyChooseUs() {
  return (
    <section className="pt-32 px-6 md:px-10 pb-0 bg-transparent w-full" id="about">
      <div className="max-w-248 mx-auto flex flex-col items-center">

        <div className="flex flex-col gap-6 items-center text-center max-w-164 w-full mb-12">
          <motion.div
          ...
          <motion.h2
            ...
            className="text-section-lg md:text-display font-medium text-plt-text leading-display tracking-normal capitalize"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
          {features.map((feature, idx) => (
            <motion.div
              ...
              className="card-shell hover:bg-plt-muted-surface transition-colors flex flex-col justify-between"
            >
              <div>
                <div className="w-10 h-10 rounded-full bg-tv-accent/10 flex items-center justify-center mb-6">
                  {feature.icon}
                </div>
                <h5 className="text-card-title font-medium text-plt-text leading-title tracking-normal mb-4">{feature.title}</h5>
